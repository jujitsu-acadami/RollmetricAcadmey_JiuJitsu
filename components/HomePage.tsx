  ...
  return (
    <div className="w-full flex-grow flex flex-col justify-between items-center text-center py-8">
      ...
      <div className="flex flex-col items-center justify-center flex-grow">
          <GlowingCircle />
          <h1 className="text-4xl sm:text-5xl font-bold text-[#F0F6FC] mt-8 tracking-tight">
              Start Your Session
          </h1>
          ...
          <div className="mt-8 space-y-4 w-full max-w-xs">
              <button 
                  ...
                  className="w-full bg-[#58A6FF] text-black py-3 rounded-lg font-bold text-lg hover:bg-blue-500 transition-colors shadow-lg shadow-[#58A6FF]/20"
              >
                  Start Drill
              </button>
              <button 
                  onClick={() => onNavigate('account')}
                  className="w-full bg-[#21262D] text-gray-300 hover:text-[#F0F6FC] py-3 rounded-lg font-semibold text-lg hover:bg-[#30363D] transition-colors border border-gray-600"
              >
                  Account & History
              </button>
          </div>
      ...
      <div className="w-full max-w-2xl mt-16">
        <div className="bg-[#161B22] border border-gray-800 rounded-lg p-4">
          <h2 className="text-[#F0F6FC] font-semibold text-base">Detailed Insights</h2>
